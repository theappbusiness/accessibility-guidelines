...
Some of the most common `InputType`s include:
- `number`
- `phone`
...
- [TextView.InputTypes developer reference](https://developer.android.com/reference/android/widget/TextView#attr_android:inputType "developer.android.com reference")
