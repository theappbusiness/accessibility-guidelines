...
*   It's best practice to only use the two-letter code representing the language (like `lang="en"`), and to not include the country as well (like `lang="en-gb"` or `lang="en-us"`).
