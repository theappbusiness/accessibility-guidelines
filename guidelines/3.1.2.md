...
## Does your page include content in more than one language? (For example, a page in English with a paragraph in Welsh).<br />&rarr; In code, identify the language of each part of the page.
...
- If a part of a page (like a section or a button) will be written in a language that's not the same as the main language of the page, make sure that you highlight this to developers on your designs.
