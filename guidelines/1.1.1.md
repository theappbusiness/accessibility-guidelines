...
* All HTML images have the `alt` attribute in their source code.
* A meaningful and accurate textual description is provided for all informative images (i.e. images that convey important information).
* A textual description of their function or destination content is provided for all functional images (i.e. images that act as links or buttons).
...
* Using a CSS `background-image` for images that convey purpose or information not already available in text. (CSS background images should only used for decorative images).
