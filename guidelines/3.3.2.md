...
The `InputDecoration()` class is used to add a lot of customization to the `TextField()` and can be used to add hints and lables.
...
child: TextField(
  ...
  decoration: InputDecoration(
    hintText: String, // optional hint paramater
    labelText: String, // optional label paramater
  ),
),
```
