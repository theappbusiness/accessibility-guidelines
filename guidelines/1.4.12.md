...
There should be no issue with text spacing provided the container of the text has infinite space to draw either vertically or horizontally depending on the scroll direction of the page.

* To ensure this make sure that the page is scrollable and do not set a fixed height and width for a widget containing text.
