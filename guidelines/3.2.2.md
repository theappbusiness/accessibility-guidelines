...
**Just changing the state of a form input (like a radio button or a dropdown) should not cause anything surprising to happen, like submitting a form, significantly changing the content on the page, or automatically moving the keyboard focus.**

---

## Requirements

Changing the state of any user interface component should not automatically cause any of the following – unless the user has been advised of what was going to happen beforehand:
