...
* If it is necessary to implement timeouts (e.g. for security reasons), users are informed when a timeout is about to occur and are given the option to extend it.
