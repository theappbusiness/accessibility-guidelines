...
There are different situations where a status message need to be shown in a way that screen readers understand. These these messages need to be conveyed to users without disturbing the user's position on a page.
