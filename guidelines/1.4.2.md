...
When audio or video plays automatically on a page, it should last for less than three seconds or there must be a easy way to pause/stop it.
...
* Audio or video that plays automatically and lasts for more than three seconds, can be easily paused and/or stopped

### Why?

This ensures that people who listen to content with a screen reader can do so without it being drowned out by the audio/video.
